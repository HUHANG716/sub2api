/**
 * Vue Router configuration for Hahacode frontend
...
const BACKEND_MODE_ALLOWED_PATHS = ['/login', '/key-usage', '/setup', '/payment/result', '/payment/airwallex', '/legal', '/docs', '/model-pricing']
