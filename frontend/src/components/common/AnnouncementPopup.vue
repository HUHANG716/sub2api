        ...
        >
          ...
          <div class="relative overflow-hidden border-b border-gray-100 bg-gray-50 px-8 py-6 dark:border-dark-700 dark:bg-dark-900">
            <div class="relative z-10">
              ...
              <div class="mb-3 flex items-center gap-2">
                ...
                <span class="inline-flex items-center gap-1.5 rounded-lg bg-primary-500 px-2.5 py-1 text-xs font-medium text-white shadow-lg shadow-primary-500/30">
          ...
          <div class="border-t border-gray-100 bg-gray-50/50 px-8 py-5 dark:border-dark-700 dark:bg-dark-900/30">
            <div class="flex items-center justify-end">
              <button
                @click="handleDismiss"
                class="rounded-xl bg-primary-500 px-6 py-2.5 text-sm font-medium text-white shadow-lg shadow-primary-500/30 transition-all hover:bg-primary-600 hover:shadow-xl hover:scale-105"
              >
