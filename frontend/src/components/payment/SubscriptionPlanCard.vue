  ...
  >
    ...
    <div class="flex flex-1 flex-col p-4">
      ...
      <div class="payment-inner-panel mb-3 grid grid-cols-2 gap-x-3 gap-y-1 rounded-lg px-3 py-2 text-xs">
        ...
        <div v-if="plan.period_limit_usd != null" class="flex items-center justify-between">
          <span class="text-gray-400 dark:text-dark-500">{{ t('payment.planCard.periodLimit') }}</span>
          <span class="font-medium text-gray-700 dark:text-gray-300">${{ plan.period_limit_usd }}</span>
        </div>
        <div v-if="plan.daily_limit_usd == null && plan.weekly_limit_usd == null && plan.monthly_limit_usd == null && plan.period_limit_usd == null" class="flex items-center justify-between">
