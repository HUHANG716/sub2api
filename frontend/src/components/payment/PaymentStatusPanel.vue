      ...
      <template v-if="!deepLinkFallbackVisible">
        <div class="card p-6">
          <div class="flex flex-col items-center space-y-4 py-4 text-center">
            ...
            <div
              v-else
              class="payment-alipay-handoff-icon flex h-12 w-12 items-center justify-center rounded-full"
            >
...
.payment-alipay-handoff-icon {
  background: color-mix(in srgb, #00aeef 10%, var(--theme-surface));
}
