  ...
  home: {
    ...
    modern: {
      ...
      hero: {
        ...
        subtitle: 'OpenAI-compatible access to Claude, GPT, Gemini, and more.',
        description: 'Connect Claude Code, Codex, Gemini CLI, and other developer tools with one API key, with keys, usage, and billing managed in one place.'
      },
      stats: {
        developers: 'Developers',
        uptime: 'Service Stability',
        taskValue: '5M+',
      ...
      supportShowcase: {
        ...
        titleAccent: 'built for creative execution',
        platformIntro: 'Start using it across these platforms:'
      },
      testimonials: {
      ...
      faq: {
        ...
        items: {
          fit: {
            ...
            answer: 'Teams already using AI coding tools in daily development.'
          },
          individual: {
            question: 'Why not let everyone configure their own tools?',
            answer: 'A shared gateway reduces long-term operating cost.'
          },
          stability: {
            question: 'How is service stability maintained?',
            answer: 'The platform continuously monitors channel health and request routing.'
          },
          start: {
            question: 'How do I get started?',
            answer: 'Log in to the workspace and follow the docs to complete the base setup.'
          }
        }
      },
      footer: {
        tagline: 'An AI coding workspace for developers',
        description: 'A unified AI development gateway for individual developers and teams.',
