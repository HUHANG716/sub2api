export default {
  ...
  keys: {
    ...
    globalDiscountRateLabel: 'Global Discount',
    globalDiscountPercentOffLabel: '{percent}% off',
    effectiveRateWithDiscount: 'Effective rate {rate}',
    noGroup: 'No group',
  ...
  usage: {
    ...
    globalDiscountApplied: 'Global discount applied',
