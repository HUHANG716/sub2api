    ...
    settings: {
      ...
      features: {
        ...
        imagePlayground: {
          ...
          description: 'Choose default OpenAI image and Responses groups for the user image playground.',
          groupLabel: 'Image Group',
          groupPlaceholder: 'Select OpenAI image group',
          responsesGroupLabel: 'Responses Group',
          responsesGroupPlaceholder: 'Use image group by default',
          groupHint: 'A dedicated key for this group is created when users open the image playground.',
          noGroups: 'No available OpenAI groups'
        },
        modelPlaza: {
          title: 'Model Plaza',
      ...
      payment: {
        ...
        balanceBonusTiers: 'Balance Recharge Bonus Tiers',
        balanceBonusTiersHint: 'Grant extra balance when the minimum recharge amount is met.',
        noBonusTiers: 'No bonus tiers yet',
        addBonusTier: 'Add Bonus Tier',
        bonusTierMinAmount: 'Minimum Recharge Amount',
        bonusTierBonusAmount: 'Bonus Amount',
        globalDiscountTitle: 'Global Usage Discount',
        globalDiscountHint: 'When enabled, users are charged the discounted amount and usage records show the deduction.',
        globalDiscountRate: 'Discount Rate',
        globalDiscountLabel: 'Discount Label',
        globalDiscountLabelPlaceholder: 'e.g. Limited 20% off',
