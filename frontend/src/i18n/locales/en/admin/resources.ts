export default {
    ...
    usage: {
      ...
      imagePlayground: {
        title: 'Image Playground Analytics',
        description: 'Review image playground submissions, successes, failures, and recent events.',
        ...
        success: 'Success',
        error: 'Error',
        loadFailed: 'Failed to load image playground analytics.'
      },
      tokenRanking: {
