export default {
  ...
  dashboard: {
    ...
    discountFrequencyDaily: 'Daily',
    discountFrequencyWeekly: 'Weekly on selected days',
    discountFrequencyMonthly: 'Monthly on selected days',
    discountSameDayEnd: 'ends same day at {time}',
    discountNextDayEnd: 'ends next day at {time}',
    discountScheduleRecurring: '{frequency} starts at {start}, {end}',
    discountScheduleOnceRange: '{start} to {end}',
    input: 'Input',
    output: 'Output',
    cache: 'Cache',
  ...
  imagePlayground: {
    ...
    createConfirmTitle: 'Create image API Key',
    createConfirmDescription: 'The image playground needs to create a dedicated API Key for the configured image group. After creation, the workspace will open automatically. Continue?',
    createConfirmAction: 'Create Key',
    ...
    renewUnsupportedGroupConfirmDescription: 'The current API Key belongs to a group that does not support image generation. Regenerate a usable image playground Key before continuing?',
  ...
  keys: {
    ...
    globalDiscountRateLabel: 'Global {discount}x discount',
    globalDiscountPercentOffLabel: 'Global {percent}% off',
    effectiveRateWithDiscount: '{base}x → {effective}x · {discountLabel}',
    created: 'Created',
  ...
  usage: {
    ...
    discountFrequencyOnce: 'One-time',
    discountFrequencyDaily: 'Daily',
    discountFrequencyWeekly: 'Weekly',
    discountFrequencyMonthly: 'Monthly',
    currentDiscountWindow: 'Current discount window',
    originalCost: 'Original cost',
    paidAmount: 'Paid',
    baseCost: 'Base',
    standardCostFull: 'Base',
    afterRateCost: 'Before discount',
    beforeDiscountCost: 'Before discount',
    globalDiscountApplied: 'Global discount',
    globalDiscountDeduction: 'Global discount deduction',
    billedAfterDiscount: 'Actual billed after discount',
    billedAfterDiscountShort: 'Discounted',
    actualBilledShort: 'Actual billed',
    discountSavedShort: 'Saved',
    discountSameDayEnd: 'ends same day at {time}',
    discountNextDayEnd: 'ends next day at {time}',
    discountScheduleRecurring: '{frequency} starts at {start}, {end}',
    discountScheduleOnceRange: '{start} to {end}',
  ...
  admin: {
    ...
    dashboard: {
      ...
      spendingRankingTotalSpend: 'Total Spend',
    ...
    usage: {
      ...
      imagePlayground: {
        title: 'Image Beta',
        description: 'Tracks submit, success, failure, and failure reasons from the embedded image playground.',
        submitCount: 'Submits',
        successCount: 'Successes',
        errorCount: 'Errors',
        successRate: 'Success Rate',
        avgDuration: 'Avg Duration',
        errorReasons: 'Failure Reasons',
        models: 'Models',
        apiModes: 'Modes',
        ...
        success: 'Success',
        error: 'Error',
        loadFailed: 'Failed to load Image Beta analytics. Please try again later.'
      },
    ...
    ops: {
      ...
      runtime: {
        ...
        metricThresholdsHint: 'Default thresholds used for health scoring and alert suggestions.',
        slaMinPercent: 'Minimum SLA (%)',
        slaMinPercentHint: 'Warn when SLA falls below this percentage.',
        ttftP99MaxMs: 'Max TTFT P99 (ms)',
        ttftP99MaxMsHint: 'Warn when first-token P99 latency is above this value.',
        requestErrorRateMaxPercent: 'Max request error rate (%)',
        requestErrorRateMaxPercentHint: 'Warn when client/business request errors exceed this percentage.',
        upstreamErrorRateMaxPercent: 'Max upstream error rate (%)',
        upstreamErrorRateMaxPercentHint: 'Warn when upstream errors exceed this percentage.',
        validation: {
          title: 'Please fix the following issues',
    ...
    settings: {
      ...
      payment: {
        ...
        globalDiscountTitle: 'Global Discount',
        globalDiscountHint: 'Applies to all user balance billing during the configured time window.',
        globalDiscountRate: 'Discount multiplier',
        globalDiscountStartsAt: 'Starts at',
        globalDiscountEndsAt: 'Ends at',
        globalDiscountLabel: 'Label',
        globalDiscountLabelPlaceholder: 'Limited-time discount',
  ...
  announcements: {
    ...
    viewAll: 'View all',
    viewAllFull: 'View all announcements',
  ...
  payment: {
    ...
    rechargeBonusPreview: 'Estimated credit ${total} (includes ${bonus})',
    rechargeBonus: 'Top-up Perks',
    ...
    creditSummaryWithBonus: 'Includes ${bonus}',
    rechargeBonusActive: 'This credit includes ${bonus}',
    rechargeBonusNext: 'Top up {amount} CNY for credit including ${bonus}',
    rechargeBonusFirst: 'Top up from {amount} CNY for credit including ${bonus}',
    ...
    quickAmountBonus: 'Includes ${bonus}',
    quickAmountBonusSuffix: 'included',
    quickAmountBonusIncluded: 'Includes ${bonus}',
    quickAmountCreditLabel: 'Total credit',
    quickAmountCredit: 'Credit ${base}',
    quickAmountCreditWithBonus: 'Credit ${base} (includes ${bonus})',
    ...
    admin: {
      ...
      funnelTitle: 'Payment Funnel',
      funnelSubtitle: 'Payment page events from the last {days} days',
      funnelPageView: 'Page Views',
      funnelSubmit: 'Order Submits',
      funnelCreated: 'Orders Created',
      ...
      conversionEmpty: 'No conversion yet',
      conversionRate: 'Conversion {rate}',
      methodSuccessCount: 'Success {count}',
      methodSubmitCount: 'Submit {count}',
      event: 'Event',
      action: 'Action',
      count: 'Count',
      operatorSummary: 'Operator Summary',
      recentAuditEvents: 'Recent Audit Actions',
      order: 'Order',
      paymentMethod: 'Payment Method',
      amount: 'Amount',
      time: 'Time',
      operatorAdmin: 'Admin #{id}',
      operatorUser: 'User #{id}',
      operatorSystem: 'System',
      operatorProvider: 'Payment provider',
      events: {
        ...
        payment_order_create_success: 'Order created',
        payment_order_create_error: 'Order create error',
        payment_launch: 'Payment launch',
        payment_success: 'Payment success',
        payment_settled: 'Payment settled',
        payment_result_view: 'Result page view',
        payment_result_status: 'Result status',
      },
      auditActions: {
        ...
        RECHARGE_RETRY: 'Fulfillment retry',
        RECHARGE_SUCCESS: 'Recharge success',
        SUBSCRIPTION_SUCCESS: 'Subscription success',
        FULFILLMENT_FAILED: 'Fulfillment failed',
        REFUND_SUCCESS: 'Refund success',
        REFUND_FAILED: 'Refund failed',
        REFUND_GATEWAY_FAILED: 'Gateway refund failed',
        REFUND_ROLLBACK_FAILED: 'Refund rollback failed',
        REFUND_NO_TRADE_NO: 'Refund without trade no.',
        REFUND_PROVIDER_METADATA_MISMATCH: 'Refund merchant mismatch',
        PAYMENT_PROVIDER_MISMATCH: 'Payment provider mismatch',
        PAYMENT_PROVIDER_METADATA_MISMATCH: 'Payment merchant mismatch',
        PAYMENT_INVALID_AMOUNT: 'Invalid payment amount',
        PAYMENT_AMOUNT_MISMATCH: 'Payment amount mismatch',
        PAYMENT_AFTER_EXPIRY: 'Payment after expiry',
