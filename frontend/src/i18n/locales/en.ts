export default {
  ...
  nav: {
    ...
    apiKeys: 'API Keys',
    imageStudio: 'GPT Image 2',
    imageStudioTemplates: 'Image Templates',
    usage: 'Usage',
    redeem: 'Redeem',
  ...
  imageStudio: {
    title: 'GPT Image 2',
    description: 'Generate or edit images with your available OpenAI groups',
    studioLabel: 'Image Studio',
    workspaceTitle: 'Creative workspace',
    balance: 'Wallet Balance',
    createMode: 'Creation mode',
    creationConsole: 'Creation console',
    modeGeneration: 'Text to Image',
    modeEdit: 'Edit',
    modeImageToImage: 'Image to Image',
    localEdit: 'Local edit',
    modeStartFromText: 'Generate',
    modeEditImage: 'Upload reference',
    modeInpaint: 'Local edit',
    modeUseTemplate: 'Templates',
    startPathHint: 'Choose how you want to start',
    modeStartFromTextDescription: 'Write an idea directly. Best for generating the first image from scratch.',
    modeEditImageDescription: 'Attach optional references without choosing a separate mode.',
    modeInpaintDescription: 'Upload a base image, then paint the area to replace or repair.',
    modeUseTemplateDescription: 'Browse real prompts, fill variables, and start faster.',
    awaitingReferenceBadge: 'Needs reference',
    editRequestBadge: 'With references',
    generationRequestBadge: 'Generate',
    group: 'OpenAI Group',
    selectGroup: 'Select group',
    prompt: 'Prompt',
    promptReadyShort: 'Prompt ready',
    promptMissingShort: 'Prompt needed',
    promptPlaceholder: 'Describe the subject, scene, style, composition, lighting, and anything to avoid...',
    imagePromptPlaceholder: 'Describe the target image. References, if uploaded, will be used as context...',
    localEditPromptPlaceholder: 'Describe how the selected area should change: replace background, remove object, adjust material, or add detail...',
    templatePromptPlaceholder: 'Start from a template, then add the specific details for your project here...',
    enhancePrompt: 'Polish prompt',
    ...
    referenceSummary: '{count} reference(s)',
    noReferenceSummary: 'No references',
    referenceRoleHint: 'Assign a purpose',
    referenceRequiredHint: 'References are optional. Templates that need one will ask for an upload.',
    referenceRoleSubject: 'Subject',
    referenceRoleStyle: 'Style',
    referenceRoleComposition: 'Composition',
    referenceRoleCharacter: 'Character',
    referenceRoleProduct: 'Product',
    uploadImages: 'Upload Images',
    localEditBaseImage: 'Base image',
    uploadBaseImage: 'Upload base image',
    changeBaseImage: 'Change base image',
    baseImageReady: 'Base image ready',
    noBaseImage: 'No base image',
    referenceDropReady: '{count} reference(s) added',
    uploadHint: 'Click, drop, or paste images. Up to 20MB each.',
    localEditUploadFirstHint: 'Local repaint needs a base image first. The mask canvas appears after upload.',
    localEditMaskHint: 'The first reference image is used as the repaint base. Paint directly on the area to change, or upload an existing mask.',
    moveEarlier: 'Move earlier',
    removeImage: 'Remove image',
    mask: 'Mask',
    uploadMask: 'Upload Mask',
    maskNotSet: 'No painted area yet',
    maskPainted: 'Local area painted',
    brushSize: 'Brush',
    undoMask: 'Undo stroke',
    clearMask: 'Clear mask',
    estimatedCost: 'Estimated Cost',
    generationPlan: 'Generation plan',
    insufficientBalanceHint: 'Estimated cost is higher than your current balance.',
    actualCost: 'Actual Cost',
    newBalance: 'New Balance',
    billingSize: 'Billing Size',
    imageCount: 'Images',
    sessionCount: 'Session Images',
    generate: 'Generate',
    generating: 'Generating...',
    generatingProgress: 'Generating {count} image(s)',
    generatingHint: 'High-resolution or multi-image requests can take longer. Keep this page open until it finishes.',
    generatingWorkspaceHint: 'Results will appear in the workspace when ready. Current settings and prompt are locked for this request.',
    ...
    useAsReferenceOnly: 'Use as reference only',
    useAsReferenceAndPrompt: 'Use reference and prompt',
    previewTitle: 'Image preview',
    latestResult: 'Latest result',
    sessionResult: 'Result #{index}',
    history: 'Recent prompts',
    clearHistory: 'Clear',
    emptyTitle: 'Generated images will appear here',
    emptyGenerationHint: 'Start from a template, or write a prompt directly to generate your first image.',
    emptyEditHint: 'Upload references first, then choose a matching template.',
    generateSuccess: 'Image generated',
    generateTimeout: '4K image generation can take longer. This request timed out; check your balance/usage later or retry with a smaller size.',
    fileTooLarge: '{name} is larger than 20MB',
    pasteSuccess: '{count} image(s) added',
    copyImageSuccess: 'Image copied',
    copyImageFailed: 'Failed to copy image',
    copyImageUnsupported: 'This browser cannot copy images directly. Please download instead.',
    referenceAdded: 'Added as reference image',
    referenceAddFailed: 'Failed to add reference image',
    downloadFailed: 'Failed to download image',
    enhanceSuffix: 'Refine this into a production-ready image prompt with clear composition, lighting, material details, camera/lens direction, color palette, background treatment, and quality constraints. Avoid distorted anatomy, unreadable text, artifacts, blur, and clutter.',
    templateGallery: 'Model-native examples',
    templateGalleryHint: '{count} real prompts with preview images',
    templateSource: 'GPT Image 2 / Nano Banana',
    templateCount: '{count} templates',
    templateSearchPlaceholder: 'Search templates, prompts, sources, or tags',
    clearTemplateSearch: 'Clear search',
    templateEmptyTitle: 'No matching templates',
    templateEmptyDescription: 'Try another keyword, or switch the filters above.',
    templateModeAll: 'All',
    templateCategoryAll: 'All',
    resultsTab: 'Results',
    templatesTab: 'Templates',
    templateMarket: 'Template market',
    sessionOnlyHint: 'Results are kept only in this session. Download them before refreshing or closing.',
    browseTemplates: 'Choose template',
    startWithReference: 'Upload reference',
    templateDetail: 'Template detail',
    templateInputs: 'Template inputs',
    resetTemplateInputs: 'Reset',
    templateNeedsReference: 'This template needs a reference image. Upload at least one image.',
    templateAppliedTitle: 'Applied: {title}',
    templateNoInputs: 'This template has no variables to fill. You can still add details to the prompt.',
    templateInputsProgress: '{filled}/{total} template variables filled. Empty fields keep their default placeholders.',
    templateReferenceNextStep: 'This template needs a reference image. Upload at least one image next.',
    editTemplateInputs: 'Edit inputs',
    appendTemplate: 'Append to prompt',
    useTemplate: 'Use and replace',
    preflightTitle: 'Before you generate',
    preflightGroup: 'Group',
    preflightGroupReady: 'An available OpenAI group is selected.',
    preflightPrompt: 'Prompt',
    preflightPromptReady: 'Prompt is ready.',
    preflightReference: 'Reference',
    preflightReferenceOptional: 'References are optional.',
    preflightBalance: 'Cost and balance',
    preflightBalanceValue: 'Estimate ${estimate}, balance ${balance}',
    preflightSelectGroup: 'Choose group',
    preflightWritePrompt: 'Write prompt',
    preflightUploadReference: 'Upload',
    preflightLowerCost: 'Lower cost',
    notReady: 'Not ready',
    readyToGenerate: 'Ready to generate',
    readyGenerationDetail: 'Aspect ratio and style are added as prompt instructions.',
    readyEditDetail: 'Reference roles are added as prompt instructions.',
    blockerLoadingOptions: 'Loading available groups and prices.',
    blockerNoGroup: 'Choose an available OpenAI group.',
    blockerNoPrompt: 'Write a prompt, or start from a template.',
    blockerNeedsReference: 'Upload at least one reference image first.',
    blockerBalance: 'Balance is too low. Lower count/size or top up before generating.',
    groupReady: 'Selected',
    promptAspectRatioInstruction: 'Aspect ratio: {ratio}. Compose the image and negative space for this ratio.',
    promptReferenceRoleInstruction: 'Reference image {index} role: {role}. Interpret this uploaded image for that role only.',
    styleInstruction: {
      photoreal: 'Style direction: photoreal. Use natural lighting, believable materials, real camera perspective, and restrained post-processing.',
      commercial: 'Style direction: commercial product. Emphasize a clear subject, polished lighting, clean background, realistic reflections, and ad-ready finish.',
      editorial: 'Style direction: editorial. Use mature composition, controlled negative space, refined color, and a cover-worthy visual system.',
      illustration: 'Style direction: illustration. Keep forms clear, edges clean, and color coherent; avoid generic stock-art styling.',
      cinematic: 'Style direction: cinematic. Use intentional depth of field, narrative lighting, atmosphere, and camera language.'
    },
    exampleGptMiniatureSkincare: 'Miniature skincare ad',
    exampleGptTvcStoryboard: 'Product TVC storyboard',
    exampleGptIndustrialSheet: 'Industrial design board',
    exampleGptMuseumHanfu: 'Chinese museum infographic',
    exampleGptWesternPoster: 'Dark western poster',
    exampleGptRecipeInfographic: 'Recipe infographic',
    exampleNanoProductStoryboard: 'Product storyboard grid',
    exampleNano3dIcons: '3D icon set',
    exampleNanoCharacterTransfer: 'Reference character transfer',
    exampleNanoFourPartStory: '4-part story',
    exampleNanoCnNewYearGrid: 'Chinese new year grid',
    exampleNanoCnWestlakeMagnet: 'West Lake enamel magnet',
    exampleNanoExplodedProduct: 'Exploded product view',
    exampleNanoTravelGuide: '3D travel guide',
    templateProduct: 'Product',
    templateProductDescription: 'Studio e-commerce shot with clean lighting and commercial polish.',
    templateProductPrompt: 'A premium product photo of [product], clean studio setup, natural shadow, realistic materials, refined highlights, commercial e-commerce composition, sharp focus.',
    templatePortrait: 'Portrait',
    templatePortraitDescription: 'Editorial portrait with skin texture, cinematic light, and shallow depth.',
    templatePortraitPrompt: 'A cinematic portrait of [person], expressive face, natural skin texture, soft key light, shallow depth of field, elegant background, high-end editorial photography.',
    templatePoster: 'Poster',
    templatePosterDescription: 'Campaign-style key visual with strong hierarchy and copy space.',
    templatePosterPrompt: 'A striking poster for [topic], bold visual hierarchy, clean typography space, dramatic composition, high contrast, polished campaign art direction.',
    templateIcon: 'Icon',
    templateIconDescription: 'Recognizable app icon direction with simple geometry and no text.',
    templateIconPrompt: 'A clean app icon for [app idea], simple recognizable symbol, balanced geometry, modern colors, subtle depth, centered composition, no text.',
    templateInterior: 'Interior',
    templateInteriorDescription: 'Realistic room scene with balanced furniture, materials, and lighting.',
    templateInteriorPrompt: 'A tasteful interior design scene for [room], layered lighting, natural materials, balanced furniture layout, realistic architectural photography.',
    templateSocial: 'Social',
    templateSocialDescription: 'Shareable editorial visual with a strong subject and negative space.',
    templateSocialPrompt: 'A social media visual for [topic], eye-catching central subject, clear negative space for copy, vibrant but refined palette, modern editorial layout.',
    templateStyleTransfer: 'Style transfer',
    templateStyleTransferDescription: 'Keep the subject, change the art direction and visual finish.',
    templateStyleTransferPrompt: 'Use the reference image as the subject and preserve its core shape, pose, and identity. Re-render it in [style], with coherent lighting, refined materials, clean edges, and no unwanted extra objects.',
    templateBackgroundReplace: 'Replace background',
    templateBackgroundReplaceDescription: 'Keep the subject intact while rebuilding the environment.',
    templateBackgroundReplacePrompt: 'Keep the main subject from the reference image unchanged. Replace the background with [new environment], matching perspective, contact shadows, reflections, and realistic lighting.',
    templateProductVariant: 'Product variant',
    templateProductVariantDescription: 'Generate a new product scene while preserving the item design.',
    templateProductVariantPrompt: 'Preserve the product design from the reference image. Create a new premium product scene with [setting], realistic scale, clean reflections, commercial lighting, and a polished e-commerce composition.',
    templateRetouch: 'Retouch',
    templateRetouchDescription: 'Clean up flaws while keeping the original image natural.',
    templateRetouchPrompt: 'Retouch the reference image naturally. Remove small distractions, improve lighting balance, sharpen important details, preserve identity and structure, and avoid over-smoothing or artificial edits.',
  },
  ...
  admin: {
    ...
    imageStudioTemplates: {
      title: 'Image Template Management',
      description: 'Review real prompts and preview images imported from GitHub. Templates appear to users only after they are enabled.',
      searchPlaceholder: 'Search title, prompt, source, or tags',
      importGitHub: 'Import GitHub',
      importing: 'Importing...',
      importSuccess: 'Import finished: {created} created, {updated} updated, {images} images',
      importPartialErrors: 'Import finished with warnings from {count} source(s)',
      importFailed: 'Failed to import GitHub templates',
      loadFailed: 'Failed to load image templates',
      updateFailed: 'Failed to update template status',
      ...
      prompt: 'Prompt',
      author: 'Author',
      requiresReference: 'Needs Reference',
      ...
      bulkEdit: 'Bulk Edit',
      bulkEditTitle: 'Bulk Edit Image Templates',
      bulkEditDescription: 'Apply these changes to {count} selected templates. Empty fields and "keep existing" options will not overwrite current values.',
      bulkEditHint: 'Bulk tags can replace, append, or remove tags. Separate multiple tags with commas.',
      applyBulkEdit: 'Apply Changes',
      bulkUpdating: 'Updating...',
      selectedCount: '{count} template(s) selected',
      clearSelection: 'Clear selection',
      selectAllVisible: 'Select all templates in the current list',
      selectTemplate: 'Select template {title}',
      keepExisting: 'Keep existing',
      tagsPlaceholder: 'Comma-separated, e.g. gpt-image-2, product',
      tagOperation: 'Tag operation',
      tagOperationReplace: 'Replace tags',
      tagOperationAppend: 'Append tags',
      tagOperationRemove: 'Remove tags',
      bulkEnable: 'Bulk Enable',
      bulkDisable: 'Bulk Disable',
      bulkEnableSuccess: '{count} template(s) enabled',
      bulkDisableSuccess: '{count} template(s) disabled',
      bulkEditSuccess: '{count} template(s) updated',
      bulkUpdateFailed: 'Bulk update failed',
      emptyTitle: 'No image templates',
      emptyDescription: 'Import real prompts and preview images from GitHub. New records stay as drafts until reviewed.'
    },
    ...
    backup: {
      ...
      s3: {
        ...
        bucket: 'Bucket',
        prefix: 'Key Prefix',
        prefixHint: 'Only database backup files use this prefix.',
        ...
        imageStudioReuseTitle: 'Image template previews can reuse this bucket',
        imageStudioReuseDescription: 'When backend image_studio.asset_storage.mode is set to backup_s3, image templates reuse this endpoint, bucket, and credentials, but they do not write into the backup prefix. Preview images use the separate image-studio/previews/ prefix, and all R2 requests stay on the server.',
        backupPrefixLabel: 'Database backup prefix',
        imageStudioPrefixLabel: 'Image template preview prefix',
        imageStudioModeHint: 'Enable it with backend config image_studio.asset_storage.mode: backup_s3.',
    ...
    settings: {
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for Hahacode end-user login',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        ...
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hahacode is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p class="tour-accent">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of Hahacode, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p class="tour-success-box" style="margin-top: 12px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p class="tour-accent" style="margin-top: 16px;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
        title: '➕ Create New Group',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Let\'s create your first group.</p><p class="tour-info-box" style="margin-bottom: 12px;"><b>📝 Tip:</b> Recommend creating a test group first to familiarize yourself with the process</p><p class="tour-accent">👉 Click the "Create Group" button</p></div>'
      },
      groupName: {
        title: '✏️ 1. Group Name',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Give your group an easy-to-identify name.</p><div class="tour-success-box" style="margin-bottom: 12px;"><b>💡 Naming Suggestions:</b><ul style="margin: 8px 0 0 16px;"><li>"Test Group" - For testing</li><li>"VIP Premium" - High-quality service</li><li>"Free Trial" - Trial version</li></ul></div><p class="tour-muted" style="font-size: 13px;">Click "Next" when done</p></div>',
        nextBtn: 'Next'
      },
      groupPlatform: {
        title: '🤖 2. Select Platform',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Choose the AI platform this group supports.</p><div class="tour-info-box" style="margin-bottom: 12px;"><b>📌 Platform Guide:</b><ul style="margin: 8px 0 0 16px;"><li><b>Anthropic</b> - Claude models</li><li><b>OpenAI</b> - GPT models</li><li><b>Google</b> - Gemini models</li></ul></div><p class="tour-muted" style="font-size: 13px;">One group can only have one platform</p></div>',
        nextBtn: 'Next'
      },
      groupMultiplier: {
        title: '💰 3. Rate Multiplier',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Set the billing multiplier to control user charges.</p><div class="tour-warning-box" style="margin-bottom: 12px;"><b>⚙️ Billing Rules:</b><ul style="margin: 8px 0 0 16px;"><li><b>1.0</b> - Original price (cost price)</li><li><b>1.5</b> - User consumes $1, charged $1.5</li><li><b>2.0</b> - User consumes $1, charged $2</li><li><b>0.8</b> - Subsidy mode (loss-making)</li></ul></div><p class="tour-muted" style="font-size: 13px;">Recommend setting test group to 1.0</p></div>',
        nextBtn: 'Next'
      },
      groupExclusive: {
        title: '🔒 4. Exclusive Group (Optional)',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Control group visibility and access permissions.</p><div class="tour-info-box" style="margin-bottom: 12px;"><b>🔐 Permission Guide:</b><ul style="margin: 8px 0 0 16px;"><li><b>Off</b> - Public group, visible to all users</li><li><b>On</b> - Exclusive group, only for specified users</li></ul></div><p class="tour-success-box"><b>💡 Use Cases:</b> VIP exclusive, internal testing, special customers</p></div>',
        nextBtn: 'Next'
      },
      groupSubmit: {
        title: '✅ Save Group',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Confirm the information and click create to save the group.</p><p class="tour-warning-box" style="margin-bottom: 12px;"><b>⚠️ Note:</b> Platform type cannot be changed after creation, but other settings can be edited anytime</p><p class="tour-success-box"><b>📌 Next Step:</b> After creation, we\'ll add upstream accounts to this group</p><p class="tour-accent" style="margin-top: 12px;">👉 Click "Create" button</p></div>'
      },
      accountManage: {
        title: '🔗 Step 2: Add Account',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>Great! Group created successfully 🎉</b></p><p style="margin-bottom: 12px;">Now add upstream AI service accounts to enable actual service delivery.</p><div class="tour-info-box" style="margin-bottom: 12px;"><b>🔑 Account Purpose:</b><ul style="margin: 8px 0 0 16px;"><li>Connect to upstream AI services (Claude, GPT, etc.)</li><li>One group can contain multiple accounts (load balancing)</li><li>Supports OAuth and Session Key methods</li></ul></div><p class="tour-accent" style="margin-top: 16px;">👉 Click "Account Management" on the left sidebar</p></div>'
      },
      createAccount: {
        title: '➕ Add New Account',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Click the button to start adding your first upstream account.</p><p class="tour-success-box"><b>💡 Tip:</b> Recommend using OAuth method - more secure and no manual key extraction needed</p><p class="tour-accent" style="margin-top: 12px;">👉 Click "Add Account" button</p></div>'
      },
      accountName: {
        title: '✏️ 1. Account Name',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Set an easy-to-identify name for the account.</p><p class="tour-success-box"><b>💡 Naming Suggestions:</b> "Claude Main", "GPT Backup 1", "Test Account", etc.</p></div>',
        nextBtn: 'Next'
      },
      accountPlatform: {
        title: '🤖 2. Select Platform',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Choose the service provider platform for this account.</p><p class="tour-warning-box"><b>⚠️ Important:</b> Platform must match the group you just created</p></div>',
        nextBtn: 'Next'
      },
      accountType: {
        title: '🔐 3. Authorization Method',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Choose the account authorization method.</p><div class="tour-success-box" style="margin-bottom: 12px;"><b>✅ Recommended: OAuth Method</b><ul style="margin: 8px 0 0 16px;"><li>No manual key extraction needed</li><li>More secure with auto-refresh support</li><li>Works with Claude Code, ChatGPT OAuth</li></ul></div><div class="tour-info-box"><b>📌 Session Key Method</b><ul style="margin: 8px 0 0 16px;"><li>Requires manual extraction from browser</li><li>May need periodic updates</li><li>For platforms without OAuth support</li></ul></div></div>',
        nextBtn: 'Next'
      },
      accountPriority: {
        title: '⚖️ 4. Priority (Optional)',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Set the account call priority.</p><div class="tour-info-box" style="margin-bottom: 12px;"><b>📊 Priority Rules:</b><ul style="margin: 8px 0 0 16px;"><li>Lower number = higher priority</li><li>System uses low-value accounts first</li><li>Same priority = random selection</li></ul></div><p class="tour-success-box"><b>💡 Use Case:</b> Set main account to lower value, backup accounts to higher value</p></div>',
        nextBtn: 'Next'
      },
      accountGroups: {
        title: '🎯 5. Assign Groups',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>Key Step!</b> Assign the account to the group you just created.</p><div class="tour-error-box" style="margin-bottom: 12px;"><b>⚠️ Important Reminder:</b><ul style="margin: 8px 0 0 16px;"><li>Must select at least one group</li><li>Unassigned accounts cannot be used</li><li>One account can be assigned to multiple groups</li></ul></div><p class="tour-success-box"><b>💡 Tip:</b> Select the test group you just created</p></div>',
        nextBtn: 'Next'
      },
      accountSubmit: {
        title: '✅ Save Account',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Confirm the information and click save.</p><div class="tour-info-box" style="margin-bottom: 12px;"><b>📌 OAuth Flow:</b><ul style="margin: 8px 0 0 16px;"><li>Will redirect to service provider page after clicking save</li><li>Complete login and authorization on provider page</li><li>Auto-return after successful authorization</li></ul></div><p class="tour-success-box"><b>📌 Next Step:</b> After adding account, we\'ll create an API key</p><p class="tour-accent" style="margin-top: 12px;">👉 Click "Save" button</p></div>'
      },
      keyManage: {
        title: '🔑 Step 3: Generate Key',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>Congratulations! Account setup complete 🎉</b></p><p style="margin-bottom: 12px;">Final step: generate an API Key to test if the service works properly.</p><div class="tour-info-box" style="margin-bottom: 12px;"><b>🔑 API Key Purpose:</b><ul style="margin: 8px 0 0 16px;"><li>Credential for calling AI services</li><li>Each key is bound to one group</li><li>Can set quota and expiration</li><li>Supports independent usage statistics</li></ul></div><p class="tour-accent" style="margin-top: 16px;">👉 Click "API Keys" on the left sidebar</p></div>'
      },
      createKey: {
        title: '➕ Create Key',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Click the button to create your first API Key.</p><p class="tour-success-box"><b>💡 Tip:</b> Copy and save immediately after creation - key is only shown once</p><p class="tour-accent" style="margin-top: 12px;">👉 Click "Create Key" button</p></div>'
      },
      keyName: {
        title: '✏️ 1. Key Name',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Set an easy-to-manage name for the key.</p><p class="tour-success-box"><b>💡 Naming Suggestions:</b> "Test Key", "Production", "Mobile", etc.</p></div>',
        nextBtn: 'Next'
      },
      keyGroup: {
        title: '🎯 2. Select Group',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Select the group you just configured.</p><div class="tour-info-box" style="margin-bottom: 12px;"><b>📌 Group Determines:</b><ul style="margin: 8px 0 0 16px;"><li>Which accounts this key can use</li><li>What billing multiplier applies</li><li>Whether it\'s an exclusive key</li></ul></div><p class="tour-success-box"><b>💡 Tip:</b> Select the test group you just created</p></div>',
        nextBtn: 'Next'
      },
      keySubmit: {
        title: '🎉 Generate and Copy',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">System will generate a complete API Key after clicking create.</p><div class="tour-error-box" style="margin-bottom: 12px;"><b>⚠️ Important Reminder:</b><ul style="margin: 8px 0 0 16px;"><li>Key is only shown once, copy immediately</li><li>Need to regenerate if lost</li><li>Keep it safe, don\'t share with others</li></ul></div><div class="tour-success-box" style="margin-bottom: 12px;"><b>🚀 Next Steps:</b><ul style="margin: 8px 0 0 16px;"><li>Copy the generated sk-xxx key</li><li>Use in any OpenAI-compatible client</li><li>Start experiencing AI services!</li></ul></div><p class="tour-accent" style="margin-top: 12px;">👉 Click "Create" button</p></div>'
      }
    },
    // User tour steps
    user: {
      welcome: {
        title: '👋 Welcome to Hahacode',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the Hahacode AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p class="tour-accent">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
        title: '🔑 API Key Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Manage all your API access keys here.</p><p class="tour-info-box"><b>📌 What is an API Key?</b><br/>An API key is your credential for accessing AI services, like a key that allows your application to call AI capabilities.</p><p class="tour-accent" style="margin-top: 12px;">👉 Click to enter key page</p></div>'
      },
      createKey: {
        title: '➕ Create New Key',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Click the button to create your first API key.</p><p class="tour-success-box"><b>💡 Tip:</b> Key is only shown once after creation, make sure to copy and save</p><p class="tour-accent" style="margin-top: 12px;">👉 Click "Create Key"</p></div>'
      },
      keyName: {
        title: '✏️ Key Name',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Give your key an easy-to-identify name.</p><p class="tour-success-box"><b>💡 Examples:</b> "My First Key", "For Testing", etc.</p></div>',
        nextBtn: 'Next'
      },
      keyGroup: {
        title: '🎯 Select Group',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Select the service group assigned by the administrator.</p><p class="tour-info-box"><b>📌 Group Info:</b><br/>Different groups may have different service quality and billing rates, choose according to your needs.</p></div>',
        nextBtn: 'Next'
      },
      keySubmit: {
        title: '🎉 Complete Creation',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Click to confirm and create your API key.</p><div class="tour-error-box" style="margin-bottom: 12px;"><b>⚠️ Important:</b><ul style="margin: 8px 0 0 16px;"><li>Copy the key (sk-xxx) immediately after creation</li><li>Key is only shown once, need to regenerate if lost</li></ul></div><p class="tour-success-box"><b>🚀 How to Use:</b><br/>Configure the key in any OpenAI-compatible client (like ChatBox, OpenCat, etc.) and start using!</p><p class="tour-accent" style="margin-top: 12px;">👉 Click "Create" button</p></div>'
      }
    }
  },
