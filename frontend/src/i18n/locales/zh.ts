export default {
  ...
  dashboard: {
    ...
    discountFrequencyDaily: '每天',
    discountFrequencyWeekly: '每周选中日期',
    discountFrequencyMonthly: '每月选中日期',
    discountSameDayEnd: '当日 {time} 结束',
    discountNextDayEnd: '次日 {time} 结束',
    discountScheduleRecurring: '{frequency} {start} 开始，{end}',
    discountScheduleOnceRange: '{start} 至 {end}',
    input: '输入',
    output: '输出',
    cache: '缓存',
    recentUsage: '最近使用',
  ...
  imagePlayground: {
    ...
    createConfirmDescription: '生图工作台需要为当前配置的生图分组创建一个专用 API Key。创建后会自动进入工作台，是否继续？',
    createConfirmAction: '创建 Key',
    ...
    renewUnsupportedGroupConfirmDescription: '当前 API Key 所在分组不支持生图。需要重新生成一个可用于生图工作台的 Key 后再继续，是否现在重新生成？',
  ...
  keys: {
    ...
    globalDiscountRateLabel: '全局 {discount} 折',
    globalDiscountPercentOffLabel: '全局优惠 {percent}%',
  ...
  usage: {
    ...
    discountFrequencyOnce: '一次性',
    discountFrequencyDaily: '每天',
    discountFrequencyWeekly: '每周',
    discountFrequencyMonthly: '每月',
    currentDiscountWindow: '当前折扣时段',
    originalCost: '原费用',
    paidAmount: '实付',
    baseCost: '基础价',
    standardCostFull: '基础价',
    afterRateCost: '折前',
    beforeDiscountCost: '折前',
    globalDiscountApplied: '全局折扣',
    globalDiscountDeduction: '全局折扣抵扣',
    billedAfterDiscount: '折后实际扣费',
    billedAfterDiscountShort: '折后实付',
    actualBilledShort: '实际扣费',
    discountSavedShort: '省',
    discountSameDayEnd: '当日 {time} 结束',
    discountNextDayEnd: '次日 {time} 结束',
    discountScheduleRecurring: '{frequency} {start} 开始，{end}',
    discountScheduleOnceRange: '{start} 至 {end}',
  ...
  admin: {
    ...
    dashboard: {
      ...
      spendingRankingTotalSpend: '消费总额',
    ...
    usage: {
      ...
      imagePlayground: {
        title: '生图 Beta',
        description: '统计内嵌生图工作台的提交、成功、失败和失败原因。',
        submitCount: '提交',
        successCount: '成功',
        errorCount: '失败',
        successRate: '成功率',
        ...
        success: '成功',
        error: '失败',
        loadFailed: '生图 Beta 统计加载失败，请稍后重试。'
      },
    ...
    ops: {
      ...
      runtime: {
        ...
        metricThresholds: '核心指标阈值',
        metricThresholdsHint: '用于健康评分和告警建议的默认阈值。',
        slaMinPercent: 'SLA 最低值 (%)',
        slaMinPercentHint: '低于该值时视为服务质量下降。',
        ttftP99MaxMs: 'TTFT P99 最大值 (ms)',
        ttftP99MaxMsHint: '首 Token P99 延迟高于该值时提示风险。',
        requestErrorRateMaxPercent: '请求错误率上限 (%)',
        requestErrorRateMaxPercentHint: '客户端/业务请求错误率高于该值时提示风险。',
        upstreamErrorRateMaxPercent: '上游错误率上限 (%)',
        upstreamErrorRateMaxPercentHint: '上游错误率高于该值时提示风险。',
        validation: {
          title: '请先修正以下问题',
          invalid: '设置不合法',
    ...
    settings: {
      ...
      payment: {
        ...
        globalDiscountTitle: '全局折扣',
        globalDiscountHint: '在配置的时间段内，对所有用户余额扣费统一生效。',
        globalDiscountRate: '折扣倍率',
        globalDiscountStartsAt: '开始时间',
        globalDiscountEndsAt: '结束时间',
        globalDiscountLabel: '活动名称',
        globalDiscountLabelPlaceholder: '限时优惠',
  ...
  payment: {
    ...
    rechargeBonusPreview: '预计到账 ${total}（含 ${bonus} 赠送）',
    rechargeBonus: '充值权益',
    baseCredit: '基础到账',
    estimatedCredit: '预计到账总额',
    creditComposition: '到账构成',
    creditSummaryBaseOnly: '按当前充值比例计算',
    creditSummaryWithBonus: '含 ${bonus} 赠送',
    rechargeBonusActive: '本次到账含 ${bonus} 赠送',
    rechargeBonusNext: '充值满 {amount} CNY，到账含 ${bonus} 赠送',
    rechargeBonusFirst: '充值满 {amount} CNY 起，到账含 ${bonus} 赠送',
    rechargeBonusRate: '当前充值比例：1 CNY = {usd} USD',
    rechargeBonusNeedMore: '本次充值金额达到 {amount} CNY 可解锁下一档奖励',
    rechargeBonusBannerHint: '包含额度会在支付成功后自动计入账户余额',
    quickAmountBonus: '含 ${bonus} 赠送',
    quickAmountBonusSuffix: '含',
    quickAmountBonusIncluded: '含 ${bonus} 赠送',
    quickAmountCreditLabel: '到账总额',
    quickAmountCredit: '到账 ${base}',
    quickAmountCreditWithBonus: '到账 ${base}（含 ${bonus} 赠送）',
    refundReason: '退款原因',
    ...
    admin: {
      ...
      funnelTitle: '支付漏斗',
      funnelSubtitle: '最近 {days} 天的支付页埋点',
      ...
      conversionRate: '转化 {rate}',
      methodSuccessCount: '成功 {count}',
      methodSubmitCount: '提交 {count}',
      event: '事件',
      action: '动作',
      count: '次数',
      operatorSummary: '操作者汇总',
      recentAuditEvents: '最近审计动作',
      order: '订单',
      paymentMethod: '支付方式',
      amount: '金额',
      time: '时间',
      ...
      events: {
        ...
        payment_order_create_success: '订单创建成功',
        payment_order_create_error: '订单创建失败',
        payment_launch: '拉起支付',
        payment_success: '支付成功',
        payment_settled: '支付结算',
        payment_result_view: '访问结果页',
        payment_result_status: '结果页状态',
      },
      auditActions: {
        ORDER_CREATED: '创建订单',
        ...
        ORDER_EXPIRED: '订单过期',
        ORDER_PAID: '支付到账',
        ORDER_RECOVERED: '恢复订单',
        RECHARGE_RETRY: '重试履约',
        RECHARGE_SUCCESS: '充值成功',
        SUBSCRIPTION_SUCCESS: '订阅开通',
        FULFILLMENT_FAILED: '履约失败',
        REFUND_SUCCESS: '退款成功',
        REFUND_FAILED: '退款失败',
        REFUND_GATEWAY_FAILED: '渠道退款失败',
        REFUND_ROLLBACK_FAILED: '退款回滚失败',
        REFUND_NO_TRADE_NO: '无渠道单号退款',
        REFUND_PROVIDER_METADATA_MISMATCH: '退款商户不匹配',
        PAYMENT_PROVIDER_MISMATCH: '支付渠道不匹配',
        PAYMENT_PROVIDER_METADATA_MISMATCH: '支付商户不匹配',
        PAYMENT_INVALID_AMOUNT: '支付金额无效',
        PAYMENT_AMOUNT_MISMATCH: '支付金额不一致',
        PAYMENT_AFTER_EXPIRY: '过期后支付',
        AFFILIATE_REBATE_FAILED: '返佣失败',
      },
      colUser: '用户',
      topUsers: '消费排行',
      noData: '暂无数据',
