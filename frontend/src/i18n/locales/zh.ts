export default {
  ...
  imageStudio: {
    title: 'GPT Image 2',
    description: '使用可用 OpenAI 分组生成或编辑图片',
    studioLabel: 'Image Studio',
    workspaceTitle: '创作工作台',
    balance: '钱包余额',
    createMode: '创作模式',
    creationConsole: '创作控制台',
    modeGeneration: '文生图',
    modeEdit: '图片编辑',
    modeImageToImage: '图生图',
    localEdit: '局部修改',
    modeStartFromText: '生图',
    modeEditImage: '上传参考图',
    modeInpaint: '局部改图',
    modeUseTemplate: '模板库',
    startPathHint: '先选一种开始方式',
    modeStartFromTextDescription: '直接写想法，适合从零生成第一张图。',
    modeEditImageDescription: '把图片作为可选参考，不单独区分生成模式。',
    modeInpaintDescription: '先上传底图，再涂抹需要替换或修复的区域。',
    modeUseTemplateDescription: '浏览真实案例 Prompt，替换变量后快速开始。',
    awaitingReferenceBadge: '待参考图',
    editRequestBadge: '含参考图',
    generationRequestBadge: '生成',
    group: 'OpenAI 分组',
    selectGroup: '选择分组',
    prompt: 'Prompt',
    promptReadyShort: 'Prompt 已就绪',
    promptMissingShort: '待填写 Prompt',
    promptPlaceholder: '描述主体、场景、风格、构图、光线，以及需要避免的内容...',
    imagePromptPlaceholder: '描述目标画面；如有参考图，会一起作为参考...',
    localEditPromptPlaceholder: '说明选中区域要如何修改，例如替换背景、移除物体、调整材质或补充细节...',
    templatePromptPlaceholder: '从模板开始后，可以在这里继续补充你的具体需求...',
    enhancePrompt: '优化 Prompt',
    aspectRatio: '画面比例',
    styleDirection: '风格方向',
    styleNone: '自动',
    stylePhotoreal: '真实摄影',
    styleCommercial: '商业产品',
    styleEditorial: '编辑部',
    ...
    outputPlan: '输出方案',
    referenceImages: '参考图',
    manageReferences: '管理参考图',
    referenceSummary: '{count} 张参考图',
    noReferenceSummary: '无参考图',
    referenceRoleHint: '给每张图分配用途',
    referenceRequiredHint: '参考图是可选输入；需要参考图的模板会提示上传。',
    referenceRoleSubject: '主体参考',
    referenceRoleStyle: '风格参考',
    referenceRoleComposition: '构图参考',
    referenceRoleCharacter: '角色一致',
    referenceRoleProduct: '产品一致',
    uploadImages: '上传图片',
    localEditBaseImage: '底图',
    uploadBaseImage: '上传底图',
    changeBaseImage: '更换底图',
    baseImageReady: '底图已就绪',
    noBaseImage: '未上传底图',
    referenceDropReady: '已添加 {count} 张参考图',
    uploadHint: '点击、拖拽或直接粘贴图片，单张最大 20MB',
    localEditUploadFirstHint: '局部重绘需要先上传一张底图，上传后会自动显示 Mask 画布。',
    localEditMaskHint: '第一张参考图会作为局部重绘底图。直接在图上涂抹要修改的区域，也可以上传已有 Mask。',
    moveEarlier: '前移',
    removeImage: '移除图片',
    mask: 'Mask',
    uploadMask: '上传 Mask',
    ...
    estimatedCost: '预估费用',
    generationPlan: '生成方案',
    insufficientBalanceHint: '预估费用高于当前余额，请确认余额后再生成。',
    actualCost: '实际费用',
    newBalance: '最新余额',
    billingSize: '计费尺寸',
    imageCount: '图片数',
    ...
    generate: '生成',
    generating: '生成中...',
    generatingProgress: '正在生成 {count} 张',
    generatingHint: '高分辨率或多图请求可能需要更久，完成前请保持页面打开。',
    generatingWorkspaceHint: '结果生成后会自动出现在工作台，当前设置和 Prompt 已锁定用于本次请求。',
    regenerate: '重新生成',
    downloadAll: '全部下载',
    clearSession: '清空会话',
    downloadImage: '下载图片',
    ...
    useAsReferenceOnly: '仅作为参考图',
    useAsReferenceAndPrompt: '作为参考并沿用 Prompt',
    previewTitle: '图片预览',
    latestResult: '最新结果',
    sessionResult: '第 {index} 组结果',
    history: '最近 Prompt',
    clearHistory: '清空',
    emptyTitle: '生成结果会显示在这里',
    emptyGenerationHint: '可以从模板开始，也可以直接写 Prompt 生成第一张图。',
    emptyEditHint: '可以先上传参考图，再选择适合的模板。',
    generateSuccess: '图片生成成功',
    generateTimeout: '4K 图片生成可能需要更久，当前请求已超时。请稍后查看余额/使用记录，或降低尺寸后重试。',
    fileTooLarge: '{name} 超过 20MB',
    pasteSuccess: '已添加 {count} 张图片',
    copyImageSuccess: '图片已复制',
    copyImageFailed: '复制图片失败',
    copyImageUnsupported: '当前浏览器不支持直接复制图片，请下载后使用。',
    referenceAdded: '已添加为参考图',
    referenceAddFailed: '添加参考图失败',
    downloadFailed: '下载图片失败',
    enhanceSuffix: '请将这个想法优化成可直接用于生图的高质量 Prompt，补充清晰的构图、光线、材质细节、镜头/视角、色彩方案、背景处理和质量约束。避免肢体畸形、文字不可读、伪影、模糊和画面杂乱。',
    templateGallery: '模型专用样例',
    templateGalleryHint: '已整理 {count} 个真实 Prompt 和预览图',
    templateSource: 'GPT Image 2 / Nano Banana',
    templateCount: '{count} 个模板',
    templateSearchPlaceholder: '搜索模板、Prompt、来源或标签',
    clearTemplateSearch: '清空搜索',
    templateEmptyTitle: '没有匹配的模板',
    templateEmptyDescription: '换个关键词，或切换上方筛选器查看其他模板。',
    templateModeAll: '全部',
    templateCategoryAll: '全部',
    resultsTab: '生成结果',
    templatesTab: '模板库',
    templateMarket: '模板市场',
    sessionOnlyHint: '结果仅保存在当前会话，刷新或关闭前请先下载。',
    browseTemplates: '选择模板',
    startWithReference: '上传参考图',
    templateDetail: '模板详情',
    templateInputs: '模板变量',
    resetTemplateInputs: '重置',
    templateNeedsReference: '这个模板需要参考图，请上传至少一张图片。',
    templateAppliedTitle: '已套用：{title}',
    templateNoInputs: '这个模板没有需要填写的变量，可以继续补充 Prompt。',
    templateInputsProgress: '模板变量已填写 {filled}/{total}，未填写项会使用默认占位。',
    templateReferenceNextStep: '这个模板需要参考图，下一步请上传至少一张图片。',
    editTemplateInputs: '编辑变量',
    appendTemplate: '追加到 Prompt',
    useTemplate: '使用并替换',
    preflightTitle: '生成前检查',
    preflightGroup: '分组',
    preflightGroupReady: '已选择可用 OpenAI 分组。',
    preflightPrompt: 'Prompt',
    preflightPromptReady: 'Prompt 已准备好。',
    preflightReference: '参考图',
    preflightReferenceOptional: '参考图为可选。',
    preflightBalance: '费用与余额',
    preflightBalanceValue: '预计 ${estimate}，余额 ${balance}',
    preflightSelectGroup: '选择分组',
    preflightWritePrompt: '填写 Prompt',
    preflightUploadReference: '上传',
    preflightLowerCost: '降低费用',
    notReady: '还不能生成',
    readyToGenerate: '可以生成',
    readyGenerationDetail: '比例和风格会作为 Prompt 指令传入。',
    readyEditDetail: '参考图用途会作为 Prompt 指令传入。',
    blockerLoadingOptions: '正在加载可用分组和价格，请稍等。',
    blockerNoGroup: '请选择一个可用 OpenAI 分组。',
    blockerNoPrompt: '先写 Prompt，或从模板库选择一个模板。',
    blockerNeedsReference: '请先上传至少一张参考图。',
    blockerBalance: '余额不足，请降低数量/尺寸或充值后再生成。',
    groupReady: '已选择',
    promptAspectRatioInstruction: '画面比例：{ratio}。请按这个比例组织构图和留白。',
    promptReferenceRoleInstruction: '参考图 {index} 用途：{role}。请按该用途理解上传图片，不要混淆不同参考图的作用。',
    styleInstruction: {
      photoreal: '风格方向：真实摄影。使用自然光影、可信材质、真实镜头透视和克制后期。',
      commercial: '风格方向：商业产品。强调清晰主体、精致布光、干净背景、真实反射和可用于电商/广告的完成度。',
      editorial: '风格方向：编辑部视觉。构图成熟、留白克制、色彩高级、适合封面或专题内容。',
      illustration: '风格方向：插画。保持形体清楚、边缘干净、色彩统一，不要做成廉价素材感。',
      cinematic: '风格方向：电影感。使用明确景深、叙事光线、环境氛围和镜头语言。'
    },
    exampleGptMiniatureSkincare: '微缩护肤广告',
    exampleGptTvcStoryboard: '商品 TVC 分镜',
    exampleGptIndustrialSheet: '工业设计提案板',
    exampleGptMuseumHanfu: '中文博物馆图鉴',
    exampleGptWesternPoster: '暗黑西部海报',
    exampleGptRecipeInfographic: '食谱信息图',
    exampleNanoProductStoryboard: '商品九宫格分镜',
    exampleNano3dIcons: '3D 图标套组',
    exampleNanoCharacterTransfer: '参考图角色转换',
    exampleNanoFourPartStory: '四格连续故事',
    exampleNanoCnNewYearGrid: '中文新年九宫格',
    exampleNanoCnWestlakeMagnet: '西湖珐琅冰箱贴',
    exampleNanoExplodedProduct: '产品爆炸拆解图',
    exampleNanoTravelGuide: '3D 旅行指南',
    templateProduct: '产品图',
    templateProductDescription: '适合电商和商品展示的棚拍质感模板。',
    templateProductPrompt: '一张高级产品摄影图，主体是 [产品]，干净棚拍环境，自然阴影，真实材质，精致高光，商业电商构图，清晰锐利。',
    templatePortrait: '人像',
    templatePortraitDescription: '编辑部摄影风格，强调肤质、光线和浅景深。',
    templatePortraitPrompt: '一张电影感人像，主体是 [人物]，表情自然，有真实皮肤质感，柔和主光，浅景深，高级编辑部摄影风格，背景优雅。',
    templatePoster: '海报',
    templatePosterDescription: '适合活动主视觉和封面，层级清楚并预留文案空间。',
    templatePosterPrompt: '为 [主题] 设计一张有冲击力的海报，视觉层级清楚，预留文字空间，戏剧化构图，高对比度，成熟的活动视觉风格。',
    templateIcon: '图标',
    templateIconDescription: '适合 App 图标和品牌符号草稿，几何简洁。',
    templateIconPrompt: '为 [应用想法] 设计一个简洁 App 图标，符号易识别，几何比例平衡，现代配色，轻微纵深感，居中构图，不要文字。',
    templateInterior: '室内',
    templateInteriorDescription: '适合空间设计、家装方案和建筑摄影效果。',
    templateInteriorPrompt: '一个有品位的 [房间] 室内设计场景，层次丰富的灯光，自然材质，家具布局协调，真实建筑摄影质感。',
    templateSocial: '社媒图',
    templateSocialDescription: '适合小红书/微博/封面配图，主体明确且留白充足。',
    templateSocialPrompt: '一张关于 [主题] 的社媒视觉图，中心主体醒目，留有清晰文案空间，配色鲜明但高级，现代编辑排版风格。',
    templateStyleTransfer: '风格转换',
    templateStyleTransferDescription: '保留主体，改变整体艺术风格和质感。',
    templateStyleTransferPrompt: '以参考图为主体，保留核心形状、姿态和身份特征。将其重新渲染为 [风格]，光线统一，材质精致，边缘干净，不要添加无关物体。',
    templateBackgroundReplace: '替换背景',
    templateBackgroundReplaceDescription: '主体不变，重建环境、光影和接触阴影。',
    templateBackgroundReplacePrompt: '保持参考图中的主体不变。将背景替换为 [新环境]，匹配透视关系、接触阴影、反射和真实光线。',
    templateProductVariant: '商品变体',
    templateProductVariantDescription: '保留商品设计，生成新的展示场景。',
    templateProductVariantPrompt: '保留参考图中的产品设计。创建一个新的高级产品展示场景：[场景]，比例真实，反射干净，商业布光，电商构图精致。',
    templateRetouch: '自然修图',
    templateRetouchDescription: '清理瑕疵、优化光线，同时保持自然真实。',
    templateRetouchPrompt: '对参考图进行自然修图。移除小干扰物，改善光线平衡，增强关键细节，保留身份和结构，不要过度磨皮或产生人工痕迹。',
  },
  ...
  admin: {
    ...
    imageStudioTemplates: {
      title: '图片模板管理',
      description: '审核 GitHub 导入的真实 Prompt 和预览图，上架后才会出现在用户端模板库。',
      searchPlaceholder: '搜索标题、Prompt、来源或标签',
      importGitHub: '导入 GitHub',
      importing: '导入中...',
      importSuccess: '导入完成：新增 {created}，更新 {updated}，图片 {images} 张',
      importPartialErrors: '导入完成，但有 {count} 个来源出现警告',
      importFailed: '导入 GitHub 模板失败',
      loadFailed: '加载图片模板失败',
      updateFailed: '更新模板状态失败',
      enableSuccess: '模板已上架',
      disableSuccess: '模板已下架',
      total: '全部模板',
      draft: '草稿',
      enabled: '已上架',
      allStatus: '全部状态',
      ...
      disable: '下架',
      editTags: '编辑标签',
      editTagsTitle: '编辑标签：{title}',
      tagSuggestions: '已有标签',
      tagUpdating: '保存中...',
      tagUpdateSuccess: '标签已更新',
      tagUpdateFailed: '标签更新失败',
      bulkEdit: '批量编辑',
      bulkEditTitle: '批量编辑图片模板',
      bulkEditDescription: '将对已选择的 {count} 个模板应用以下修改。留空或选择保持不变的字段不会覆盖原值。',
      bulkEditHint: '批量标签支持替换、追加或移除；多个标签用英文逗号分隔。',
      applyBulkEdit: '应用修改',
      bulkUpdating: '更新中...',
      selectedCount: '已选择 {count} 个模板',
      clearSelection: '清空选择',
      selectAllVisible: '选择当前列表中的全部模板',
      selectTemplate: '选择模板 {title}',
      keepExisting: '保持不变',
      tagsPlaceholder: '英文逗号分隔，例如 gpt-image-2, product',
      tagOperation: '标签操作',
      tagOperationReplace: '替换标签',
      tagOperationAppend: '追加标签',
      tagOperationRemove: '移除标签',
      bulkEnable: '批量上架',
      bulkDisable: '批量下架',
      bulkEnableSuccess: '已上架 {count} 个模板',
      bulkDisableSuccess: '已下架 {count} 个模板',
      bulkEditSuccess: '已更新 {count} 个模板',
      bulkUpdateFailed: '批量更新失败',
      emptyTitle: '暂无图片模板',
      emptyDescription: '从 GitHub 导入真实 Prompt 和预览图后，会先以草稿状态进入这里等待审核。'
    },
    ...
    backup: {
      ...
      s3: {
        ...
        saved: 'S3 配置已保存',
        imageStudioReuseTitle: '图片模板预览图可复用这个桶',
        imageStudioReuseDescription: '当后端 image_studio.asset_storage.mode 设置为 backup_s3 时，图片模板会复用此处的端点、桶和密钥，但不会写入备份目录；预览图使用独立前缀 image-studio/previews/，并且所有 R2 请求都由服务端完成。',
        backupPrefixLabel: '数据库备份目录',
        imageStudioPrefixLabel: '图片模板预览图目录',
        imageStudioModeHint: '启用方式：在后端配置 image_studio.asset_storage.mode: backup_s3。',
        bucketRoot: '存储桶根目录'
      },
      schedule: {
        title: '定时备份',
    ...
    settings: {
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 Hahacode 用户登录',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 Hahacode',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hahacode 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p class="tour-accent">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 Hahacode 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p class="tour-success-box" style="margin-top: 12px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p class="tour-accent" style="margin-top: 16px;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">现在让我们创建第一个分组。</p><p class="tour-info-box" style="margin-bottom: 12px;"><b>📝 提示：</b>建议先创建一个测试分组，熟悉流程后再创建正式分组</p><p class="tour-accent">👉 点击"创建分组"按钮</p></div>'
      },
      groupName: {
        title: '✏️ 1. 分组名称',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">为您的分组起一个易于识别的名称。</p><div class="tour-success-box" style="margin-bottom: 12px;"><b>💡 命名建议：</b><ul style="margin: 8px 0 0 16px;"><li>"测试分组" - 用于测试</li><li>"VIP专线" - 高质量服务</li><li>"免费试用" - 体验版</li></ul></div><p class="tour-muted" style="font-size: 13px;">填写完成后点击"下一步"继续</p></div>',
        nextBtn: '下一步'
      },
      groupPlatform: {
        title: '🤖 2. 选择平台',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">选择该分组支持的 AI 平台。</p><div class="tour-info-box" style="margin-bottom: 12px;"><b>📌 平台说明：</b><ul style="margin: 8px 0 0 16px;"><li><b>Anthropic</b> - Claude 系列模型</li><li><b>OpenAI</b> - GPT 系列模型</li><li><b>Google</b> - Gemini 系列模型</li></ul></div><p class="tour-muted" style="font-size: 13px;">一个分组只能选择一个平台</p></div>',
        nextBtn: '下一步'
      },
      groupMultiplier: {
        title: '💰 3. 费率倍数',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">设置该分组的计费倍率，控制用户的实际扣费。</p><div class="tour-warning-box" style="margin-bottom: 12px;"><b>⚙️ 计费规则：</b><ul style="margin: 8px 0 0 16px;"><li><b>1.0</b> - 原价计费（成本价）</li><li><b>1.5</b> - 用户消耗 $1，扣除 $1.5</li><li><b>2.0</b> - 用户消耗 $1，扣除 $2</li><li><b>0.8</b> - 补贴模式（亏本运营）</li></ul></div><p class="tour-muted" style="font-size: 13px;">建议测试分组设置为 1.0</p></div>',
        nextBtn: '下一步'
      },
      groupExclusive: {
        title: '🔒 4. 专属分组（可选）',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">控制分组的可见性和访问权限。</p><div class="tour-info-box" style="margin-bottom: 12px;"><b>🔐 权限说明：</b><ul style="margin: 8px 0 0 16px;"><li><b>关闭</b> - 公开分组，所有用户可见</li><li><b>开启</b> - 专属分组，仅指定用户可见</li></ul></div><p class="tour-success-box"><b>💡 使用场景：</b>VIP 用户专属、内部测试、特殊客户等</p></div>',
        nextBtn: '下一步'
      },
      groupSubmit: {
        title: '✅ 保存分组',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">确认信息无误后，点击创建按钮保存分组。</p><p class="tour-warning-box" style="margin-bottom: 12px;"><b>⚠️ 注意：</b>分组创建后，平台类型不可修改，其他信息可以随时编辑</p><p class="tour-success-box"><b>📌 下一步：</b>创建成功后，我们将添加上游账号到这个分组</p><p class="tour-accent" style="margin-top: 12px;">👉 点击"创建"按钮</p></div>'
      },
      accountManage: {
        title: '🔗 第二步：添加账号',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>太棒了！分组已创建成功 🎉</b></p><p style="margin-bottom: 12px;">现在需要添加上游 AI 服务商的账号，让分组能够实际提供服务。</p><div class="tour-info-box" style="margin-bottom: 12px;"><b>🔑 账号的作用：</b><ul style="margin: 8px 0 0 16px;"><li>连接到上游 AI 服务（Claude、GPT 等）</li><li>一个分组可以包含多个账号（负载均衡）</li><li>支持 OAuth 和 Session Key 两种方式</li></ul></div><p class="tour-accent" style="margin-top: 16px;">👉 点击左侧的"账号管理"</p></div>'
      },
      createAccount: {
        title: '➕ 添加新账号',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">点击按钮开始添加您的第一个上游账号。</p><p class="tour-success-box"><b>💡 提示：</b>建议使用 OAuth 方式，更安全且无需手动提取密钥</p><p class="tour-accent" style="margin-top: 12px;">👉 点击"添加账号"按钮</p></div>'
      },
      accountName: {
        title: '✏️ 1. 账号名称',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">为账号设置一个便于识别的名称。</p><p class="tour-success-box"><b>💡 命名建议：</b>"Claude主账号"、"GPT备用1"、"测试账号" 等</p></div>',
        nextBtn: '下一步'
      },
      accountPlatform: {
        title: '🤖 2. 选择平台',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">选择该账号对应的服务商平台。</p><p class="tour-warning-box"><b>⚠️ 重要：</b>平台必须与刚才创建的分组平台一致</p></div>',
        nextBtn: '下一步'
      },
      accountType: {
        title: '🔐 3. 授权方式',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">选择账号的授权方式。</p><div class="tour-success-box" style="margin-bottom: 12px;"><b>✅ 推荐：OAuth 方式</b><ul style="margin: 8px 0 0 16px;"><li>无需手动提取密钥</li><li>更安全，支持自动刷新</li><li>适用于 Claude Code、ChatGPT OAuth</li></ul></div><div class="tour-info-box"><b>📌 Session Key 方式</b><ul style="margin: 8px 0 0 16px;"><li>需要手动从浏览器提取</li><li>可能需要定期更新</li><li>适用于不支持 OAuth 的平台</li></ul></div></div>',
        nextBtn: '下一步'
      },
      accountPriority: {
        title: '⚖️ 4. 优先级（可选）',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">设置账号的调用优先级。</p><div class="tour-info-box" style="margin-bottom: 12px;"><b>📊 优先级规则：</b><ul style="margin: 8px 0 0 16px;"><li>数字越小，优先级越高</li><li>系统优先使用低数值账号</li><li>相同优先级则随机选择</li></ul></div><p class="tour-success-box"><b>💡 使用场景：</b>主账号设置低数值，备用账号设置高数值</p></div>',
        nextBtn: '下一步'
      },
      accountGroups: {
        title: '🎯 5. 分配分组',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>关键步骤！</b>将账号分配到刚才创建的分组。</p><div class="tour-error-box" style="margin-bottom: 12px;"><b>⚠️ 重要提醒：</b><ul style="margin: 8px 0 0 16px;"><li>必须勾选至少一个分组</li><li>未分配分组的账号无法使用</li><li>一个账号可以分配给多个分组</li></ul></div><p class="tour-success-box"><b>💡 提示：</b>请勾选刚才创建的测试分组</p></div>',
        nextBtn: '下一步'
      },
      accountSubmit: {
        title: '✅ 保存账号',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">确认信息无误后，点击保存按钮。</p><div class="tour-info-box" style="margin-bottom: 12px;"><b>📌 OAuth 授权流程：</b><ul style="margin: 8px 0 0 16px;"><li>点击保存后会跳转到服务商页面</li><li>在服务商页面完成登录授权</li><li>授权成功后自动返回</li></ul></div><p class="tour-success-box"><b>📌 下一步：</b>账号添加成功后，我们将创建 API 密钥</p><p class="tour-accent" style="margin-top: 12px;">👉 点击"保存"按钮</p></div>'
      },
      keyManage: {
        title: '🔑 第三步：生成密钥',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>恭喜！账号配置完成 🎉</b></p><p style="margin-bottom: 12px;">最后一步，生成 API Key 来测试服务是否正常工作。</p><div class="tour-info-box" style="margin-bottom: 12px;"><b>🔑 API Key 的作用：</b><ul style="margin: 8px 0 0 16px;"><li>用于调用 AI 服务的凭证</li><li>每个 Key 绑定一个分组</li><li>可以设置配额和有效期</li><li>支持独立的使用统计</li></ul></div><p class="tour-accent" style="margin-top: 16px;">👉 点击左侧的"API 密钥"</p></div>'
      },
      createKey: {
        title: '➕ 创建密钥',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">点击按钮创建您的第一个 API Key。</p><p class="tour-success-box"><b>💡 提示：</b>创建后请立即复制保存，密钥只显示一次</p><p class="tour-accent" style="margin-top: 12px;">👉 点击"创建密钥"按钮</p></div>'
      },
      keyName: {
        title: '✏️ 1. 密钥名称',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">为密钥设置一个便于管理的名称。</p><p class="tour-success-box"><b>💡 命名建议：</b>"测试密钥"、"生产环境"、"移动端" 等</p></div>',
        nextBtn: '下一步'
      },
      keyGroup: {
        title: '🎯 2. 选择分组',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">选择刚才配置好的分组。</p><div class="tour-info-box" style="margin-bottom: 12px;"><b>📌 分组决定：</b><ul style="margin: 8px 0 0 16px;"><li>该密钥可以使用哪些账号</li><li>计费倍率是多少</li><li>是否为专属密钥</li></ul></div><p class="tour-success-box"><b>💡 提示：</b>选择刚才创建的测试分组</p></div>',
        nextBtn: '下一步'
      },
      keySubmit: {
        title: '🎉 生成并复制',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">点击创建后，系统会生成完整的 API Key。</p><div class="tour-error-box" style="margin-bottom: 12px;"><b>⚠️ 重要提醒：</b><ul style="margin: 8px 0 0 16px;"><li>密钥只显示一次，请立即复制</li><li>丢失后需要重新生成</li><li>妥善保管，不要泄露给他人</li></ul></div><div class="tour-success-box" style="margin-bottom: 12px;"><b>🚀 下一步：</b><ul style="margin: 8px 0 0 16px;"><li>复制生成的 sk-xxx 密钥</li><li>在支持 OpenAI 接口的客户端中使用</li><li>开始体验 AI 服务！</li></ul></div><p class="tour-accent" style="margin-top: 12px;">👉 点击"创建"按钮</p></div>'
      }
    },
    // User tour steps
    user: {
      welcome: {
        title: '👋 欢迎使用 Hahacode',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 Hahacode AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p class="tour-accent">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
        title: '🔑 API 密钥管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">在这里管理您的所有 API 访问密钥。</p><p class="tour-info-box"><b>📌 什么是 API 密钥？</b><br/>API 密钥是您访问 AI 服务的凭证，就像一把钥匙，让您的应用能够调用 AI 能力。</p><p class="tour-accent" style="margin-top: 12px;">👉 点击进入密钥页面</p></div>'
      },
      createKey: {
        title: '➕ 创建新密钥',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">点击按钮创建您的第一个 API 密钥。</p><p class="tour-success-box"><b>💡 提示：</b>创建后密钥只显示一次，请务必复制保存</p><p class="tour-accent" style="margin-top: 12px;">👉 点击"创建密钥"</p></div>'
      },
      keyName: {
        title: '✏️ 密钥名称',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">为密钥起一个便于识别的名称。</p><p class="tour-success-box"><b>💡 示例：</b>"我的第一个密钥"、"测试用" 等</p></div>',
        nextBtn: '下一步'
      },
      keyGroup: {
        title: '🎯 选择分组',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">选择管理员为您分配的服务分组。</p><p class="tour-info-box"><b>📌 分组说明：</b><br/>不同分组可能有不同的服务质量和计费标准，请根据需要选择。</p></div>',
        nextBtn: '下一步'
      },
      keySubmit: {
        title: '🎉 完成创建',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">点击确认创建您的 API 密钥。</p><div class="tour-error-box" style="margin-bottom: 12px;"><b>⚠️ 重要：</b><ul style="margin: 8px 0 0 16px;"><li>创建后请立即复制密钥（sk-xxx）</li><li>密钥只显示一次，丢失需重新生成</li></ul></div><p class="tour-success-box"><b>🚀 如何使用：</b><br/>将密钥配置到支持 OpenAI 接口的任何客户端（如 ChatBox、OpenCat 等），即可开始使用！</p><p class="tour-accent" style="margin-top: 12px;">👉 点击"创建"按钮</p></div>'
      }
    }
  },
