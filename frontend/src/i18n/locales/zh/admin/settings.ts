export default {
    settings: {
      ...
      features: {
        ...
        imagePlayground: {
          title: '生图工作台',
          description: '为用户端生图工作台选择默认 OpenAI 图片分组和 Responses 分组。',
          groupLabel: '图片分组',
          groupPlaceholder: '选择 OpenAI 图片分组',
          responsesGroupLabel: 'Responses 分组',
          responsesGroupPlaceholder: '默认使用图片分组',
          groupHint: '用户进入生图工作台时会自动创建该分组的专用密钥。',
      ...
      payment: {
        ...
        balanceBonusTiers: '余额充值赠送阶梯',
        balanceBonusTiersHint: '满足最低充值金额后，额外赠送对应余额。',
        noBonusTiers: '暂无赠送阶梯',
        addBonusTier: '添加赠送阶梯',
        bonusTierMinAmount: '最低充值金额',
        bonusTierBonusAmount: '赠送金额',
        globalDiscountTitle: '全局消费折扣',
        globalDiscountHint: '启用后，用户按折扣后的金额扣费，使用记录会显示抵扣明细。',
        globalDiscountRate: '折扣率',
        globalDiscountLabel: '折扣标签',
        globalDiscountLabelPlaceholder: '例如：限时 8 折',
