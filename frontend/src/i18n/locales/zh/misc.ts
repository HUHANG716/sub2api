export default {
  ...
  imagePlayground: {
    title: '生图工作台',
    description: '通过配置好的 OpenAI 生图分组创建和编辑图片。',
    loading: '正在准备生图工作台...',
    regenerateKey: '重新生成 API Key',
    renewConfirmTitle: '重新生成生图 API Key',
    createConfirmTitle: '创建生图 API Key',
    createConfirmDescription: '生图工作台需要为配置的图片分组创建专用 API Key。现在创建吗？',
    createConfirmAction: '创建密钥',
    renewManualConfirmDescription: '这会重新生成生图工作台专用 API Key，并刷新当前工作区。是否继续？',
    renewExpiredConfirmDescription: '生图工作台 API Key 已过期，请先重新生成后再继续。',
    renewUnsupportedGroupConfirmDescription: '当前 API Key 所属分组不支持图片生成。请重新生成可用的生图工作台密钥。',
    ...
    missingConfiguredGroupDescription: '请管理员在系统设置中选择 OpenAI 图片分组。',
    unavailableConfiguredGroupTitle: '生图工作台分组不可用',
    unavailableConfiguredGroupDescription: '配置的分组已禁用，或当前账号无权访问。',
    createFailedTitle: '无法准备生图密钥',
    createFailedDescription: '请重试，或手动创建密钥。',
    retry: '重试'
  },
  ...
  payment: {
    title: '充值/订阅',
    secureCheckout: '安全支付',
    topUpPanelTitle: '余额充值',
    channelPanelTitle: '支付通道',
    orderSummary: '订单摘要',
    balanceRecharge: '余额充值',
    estimatedCredit: '预计到账',
    creditComposition: '到账明细',
    backToPlans: '返回套餐',
    planCatalogTitle: '订阅套餐',
    creditSummaryBaseOnly: '到账 {base}',
    creditSummaryWithBonus: '到账 {base} + 赠送 {bonus}',
    quickAmountCreditLabel: '到账 {amount}',
    quickAmountBonusIncluded: '含赠送 {bonus}',
    rechargeBonusActive: '充值赠送活动进行中',
    rechargeBonusBannerHint: '满足阶梯条件后，赠送额度会随充值一起到账。',
    rechargeBonusFirst: '满 {amount} 赠送 {bonus}',
    rechargeBonusNext: '再充值 {amount} 可获得 {bonus} 赠送',
    rechargeBonusNeedMore: '还差 {amount} 可获得 {bonus} 赠送',
    amountLabel: '充值金额',
    paymentAmount: '支付金额',
    ...
    admin: {
      ...
      orderCount: '订单数',
      funnelTitle: '支付漏斗',
      funnelSubtitle: '最近 {days} 天支付转化分析',
      funnelTableMissing: '支付事件表尚未创建，暂无漏斗数据',
      noFunnelData: '暂无支付漏斗数据',
      funnelPageView: '访问支付页',
      funnelSubmit: '提交订单',
      funnelCreated: '订单创建',
      funnelLaunch: '拉起支付',
      funnelResult: '支付成功',
      uniqueUsers: '{count} 个用户',
      funnelByMethod: '按支付方式',
      methodSuccessCount: '{count} 次成功',
      methodSubmitCount: '{count} 次提交',
      newCustomers: '新付费用户',
      newCustomerCount: '{count} 人',
      recentFunnelEvents: '最近漏斗事件',
      recentAuditEvents: '最近操作日志',
      operatorSummary: '操作人汇总',
      conversionEmpty: '暂无转化',
      ...
      action: '操作',
      count: '次数',
      operatorAdmin: '管理员 #{id}',
      operatorUser: '用户 #{id}',
      operatorSystem: '系统',
      operatorProvider: '支付服务商',
      avgAmount: '平均金额',
      revenue: '收入',
      dailyRevenue: '每日收入',
