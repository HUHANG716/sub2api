export default {
  ...
  keys: {
    ...
    globalDiscountRateLabel: '全局折扣',
    globalDiscountPercentOffLabel: '{percent}% 优惠',
    effectiveRateWithDiscount: '折后倍率 {rate}',
    noGroup: '无分组',
    searchGroup: '搜索分组...',
  ...
  usage: {
    ...
    accountBilled: '账号计费',
    baseCost: '基础费用',
    beforeDiscountCost: '折前费用',
    globalDiscountApplied: '已应用全局折扣',
    globalDiscountDeduction: '全局折扣抵扣',
    paidAmount: '实付金额',
    actualRate: '实际倍率',
    discountActive: '折扣生效中',
    resetNow: '现在',
    resetPending: '待刷新',
