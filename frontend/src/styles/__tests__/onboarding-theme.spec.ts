...
const zhLocale = readFileSync(resolve(__dirname, '../../i18n/locales/zh/index.ts'), 'utf8')
const enLocale = readFileSync(resolve(__dirname, '../../i18n/locales/en/index.ts'), 'utf8')
