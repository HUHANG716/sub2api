...
<template>
  <div class="theme-panel rounded-3xl p-6">
    ...
    >
      ...
      <div v-else class="space-y-5">
        <div class="ops-inner-card rounded-xl p-4">
          <div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
              <div class="flex items-center gap-2 rounded-lg px-2 py-1 ring-1 ring-gray-200 dark:bg-white/5 dark:ring-white/10">
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div class="ops-inner-card rounded-xl p-4">
              ...
              <div class="mt-1 flex flex-wrap items-center gap-2">
                ...
                <a
                  class="inline-flex items-center gap-1 rounded-md bg-white px-2 py-1 text-[11px] font-bold text-gray-700 ring-1 ring-gray-200 hover:bg-gray-50 dark:bg-white/5 dark:text-gray-200 dark:ring-white/10 dark:hover:bg-white/10"
