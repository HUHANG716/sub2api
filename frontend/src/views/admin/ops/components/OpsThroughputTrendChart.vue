  ...
  <div class="theme-panel flex h-full flex-col rounded-3xl p-6">
    <div class="mb-4 flex shrink-0 items-center justify-between">
      ...
      <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
        ...
        <template v-if="!props.fullscreen">
          <button
            type="button"
            class="ops-compact-button ml-2 inline-flex items-center rounded-lg px-2 py-1 text-[11px] font-semibold disabled:opacity-50"
          ...
          <button
            type="button"
            class="ops-compact-button inline-flex items-center rounded-lg px-2 py-1 text-[11px] font-semibold disabled:opacity-50"
            :disabled="state !== 'ready'"
    ...
    <div v-if="(props.topGroups?.length ?? 0) > 0" class="mb-3 flex flex-wrap gap-2">
      <button
        ...
        :key="g.group_id"
        type="button"
        class="ops-compact-button inline-flex items-center gap-2 rounded-full px-3 py-1 text-[11px] font-semibold"
