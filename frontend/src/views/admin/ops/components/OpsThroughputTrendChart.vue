...
<template>
  <div class="theme-panel flex h-full min-w-0 flex-col rounded-3xl p-6">
    <div
    ...
    >
      ...
      >
        ...
        <template v-if="!props.fullscreen">
          <button
            type="button"
            class="ops-compact-button inline-flex shrink-0 items-center rounded-lg px-2 py-1 text-[11px] font-semibold disabled:opacity-50"
