...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	imageStudioTemplateRepository := repository.NewImageStudioTemplateRepository(client)
	imageStudioTemplateAssetStore := repository.NewImageStudioTemplateAssetStore(configConfig, settingRepository, secretEncryptor)
	imageStudioService := service.NewImageStudioService(apiKeyService, userRepository, groupRepository, billingService, imageStudioTemplateRepository, imageStudioTemplateAssetStore)
	...
	imageStudioHandler := handler.NewImageStudioHandler(imageStudioService, openAIGatewayService, openAIGatewayHandler, apiKeyService, billingCacheService)
	...
	imageStudioTemplateHandler := admin.NewImageStudioTemplateHandler(imageStudioService)
	contentModerationHandler := admin.NewContentModerationHandler(contentModerationService)
	paymentHandler := admin.NewPaymentHandler(paymentService, paymentConfigService)
	affiliateHandler := admin.NewAffiliateHandler(affiliateService, adminService)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, imageStudioTemplateHandler, contentModerationHandler, paymentHandler, affiliateHandler)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, imageStudioHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, idempotencyCoordinator, idempotencyCleanupService)
