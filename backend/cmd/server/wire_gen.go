...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	usageHandler := handler.ProvideUsageHandler(usageService, apiKeyService, billingService, modelPricingResolver, userGroupRateRepository, settingService, db)
	...
	publicModelPricingHandler := handler.NewPublicModelPricingHandler(pricingService)
