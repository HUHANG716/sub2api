...
func (_c *UserCreate) AddBenefitClaimIDs(ids ...int64) *UserCreate {
	_c.mutation.AddBenefitClaimIDs(ids...)
	return _c
}

// AddBenefitClaims adds the "benefit_claims" edges to the BenefitClaim entity.
func (_c *UserCreate) AddBenefitClaims(v ...*BenefitClaim) *UserCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddBenefitClaimIDs(ids...)
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.BenefitClaimsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
