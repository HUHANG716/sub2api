...
func (r *stubUsageLogRepo) GetUserSpendingRanking(ctx context.Context, startTime, endTime time.Time, limit int, userRole string) (*usagestats.UserSpendingRankingResponse, error) {
	return nil, errors.New("not implemented")
}
