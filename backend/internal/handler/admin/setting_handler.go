...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		PaymentBalanceBonusTiers:               paymentCfg.BalanceBonusTiers,
...
type UpdateSettingsRequest struct {
	...
	PaymentBalanceBonusTiers         *[]service.BalanceRechargeBonusTier `json:"payment_balance_bonus_tiers"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	if h.paymentConfigService != nil && hasPaymentFields(req) {
		paymentReq := service.UpdatePaymentConfigRequest{
			...
			BalanceBonusTiers:         req.PaymentBalanceBonusTiers,
	...
	payload := dto.SystemSettings{
		...
		PaymentBalanceBonusTiers:               updatedPaymentCfg.BalanceBonusTiers,
...
func hasPaymentFields(req UpdateSettingsRequest) bool {
	return req.PaymentEnabled != nil || req.PaymentMinAmount != nil ||
		...
		req.PaymentBalanceRechargeMultiplier != nil || req.PaymentBalanceBonusTiers != nil ||
