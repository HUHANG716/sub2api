...
export default function SupportPromptModal() {
  ...
  const visible = !productEmbed && supportPromptOpen && !blockedByHigherPriorityModal
    ...
    >
      ...
      >
        ...
        <button
          type="button"
          onClick={dismissSupportPrompt}
          className="rounded-2xl bg-[#946ce6] px-5 py-3.5 text-[15px] font-semibold text-white transition-all hover:bg-[#8358dc] active:scale-[0.98] dark:bg-[#946ce6] dark:hover:bg-[#a885ee]"
        >
          我知道了
        </button>
      </div>
