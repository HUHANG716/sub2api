      ...
      <div className="flex gap-2 flex-shrink-0 z-20">
        ...
        {inCollectionOverview && (
          <button
            ...
            className={`${productEmbed ? 'p-2 rounded-lg' : 'p-2.5 rounded-xl'} border border-gray-200 dark:border-white/[0.08] bg-white dark:bg-gray-900 text-gray-400 hover:bg-gray-50 dark:hover:bg-white/[0.06] transition-all`}
            title="管理收藏夹"
          >
